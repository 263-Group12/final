...
const text = responsiveFontSizes(createMuiTheme());
                ...
                <ThemeProvider theme={text}>
                    <Grid container spacing={3}>
                        ...
                        <GridEntry right>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                Create an extensible platform that focuses on managing budgets (i.e. short-and-medium
                                term
                                spending) and their context of the user’s assets. Day to day, the FI/RE follower needs
                                to
                                ...
                                strongly related and support each other. Our plan is to establish a means for creating
                                and
                                tracking budgets and tie those budgets into long term financial goals and progress to
                                those
                                goals. We will do this by creating a web app for creating the budgets and integrate
                                those
                                budgets with whatever spending accounts a user has (Credit Cards, Bank Accounts) to
                                track
                                their usage. Then we will proliferate those budgets to all their devices, making it
                                ubiquitous and keeping them accountable to their personally set budgets. Then we will
                                create
                                a section of that web app for planning out their financial independence goals, and their
                                current assets. We will generate reports for their investments and savings rates and
                                give
                        ...
                        <GridEntry left>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                2. Do people think they are good at making & following their financial plans?(Do they
                                think
                        ...
                        <GridEntry left>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                ...
                                protocol seen in the appendix to ensure we all asked similar questions, allowing us to
                                get a
                                relatively unified understanding of the differences of user profiles. Each interviewer
                                timed
                                themselves and we agreed that we should intend to finish different sections by the times
                                listed in the protocol. However, if time was short, interviewers could skip the
                                credit/debt
                                ...
                                Zoom to organize these notes into affinity groups. From there we summarized each
                                affinity
                        ...
                        <GridEntry>
                            ...
                            <Typography variant={"body1"}>
                                A portion of our affinity diagram. Yellow sticky notes are our interview notes. Green
                                sticky
                        ...
                        <GridEntry>
                            ...
                            <img style={myStyle} src={"../competitors/MINT.gif"} width={"55%"}
                                 alt={"Mint Example Screen"}/>
                            ...
                            <Grid container item xs={12} spacing={1}>
                                ...
                                <Grid item xs={6}>
                                    <Paper style={section}>
                                        ...
                                        <br/>- The value proposition to the user is the ability to see how they are
                                        doing
                                        against their budgets in real time.
                                        <br/>- The system has integrations to many financial institutions like Credit
                                        Card
                                        companies and Banks.
                                    </Paper>
                                </Grid>
                            ...
                            <Grid container item xs={12} spacing={1}>
                                ...
                                <Grid item xs={6}>
                                    <Paper style={section}>
                                        ...
                                        <br/>- Keep track of every financial related activity in just one place.
                                        <br/>- Some users review that they actually gain credit scores since they were
                                        able
                            ...
                            <Grid container item xs={12} spacing={1}>
                                ...
                                <Grid item xs={6}>
                                    <Paper style={section}>
                                        ...
                                        <br/>- It lets users keep track of the companies they’re currently trading and
                                        also
                            ...
                            <Grid container item xs={12} spacing={1}>
                                ...
                                <Grid item xs={6}>
                                    <Paper style={section}>
                                        ...
                                        computer knowledge.
                                        <br/>- It is a reputable company that many people trust to handle their money as
                                        it
                        ...
                        <GridEntry right>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                2. Many people’s goals to reach financial independence is through being mentally
                                conscious
                                of their spending and by making safe investments that they mostly can
                                set-and-forget </Typography>
                            <Typography align={"left"} variant={"body1"}>
                                3. Many people weren’t as familiar with financial planning as they’d like and would like
                                to
                        ...
                        <GridEntry left>
                            ...
                            <img style={myStyle} src={"../personas/Clarice.png"} width={"100%"}
                                 alt={"Clarice Persona"}/>
                        ...
                        <GridEntry left>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                We created multiple iterations of our application design using Figma. We started with a
                                low
                        ...
                        <GridEntry right>
                            ...
                            <img style={myStyle} src={"../LowFidWireframes.png"} width={"100%"}
                                 alt={"Wireframe screens"}/>
                            <Typography variant={"body1"}>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                ...
                                on the application’s key purpose and functionality rather than its aesthetic. Our
                                wireframe
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                4. A resources section to provide the user with education materials in order to become
                                more
                        ...
                        <GridEntry left>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                ...
                                accurately depict our final vision for our product. We asked users to perform a series
                                of
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                1. Can you explore the resource page and tell me what you think about it? (What can it
                                do &
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                4. Can you go link a bank account to your app account? Can you remove a linked account
                                from
                                your application? </Typography>
                            <Typography align={"left"} variant={"body1"}>
                                5. Can you open up your performance report? What else do you think you’d like to see on
                                your
                                report?
                            </Typography>
                        </GridEntry>
                        <GridEntry right>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                Based on these user evaluations, we compiled a list of usability issues. We then fixed
                                these
                                issues and constructed our high-fidelity prototype. Our team members then compiled our
                                own
                                list of usability issues based on the <a
                                href={"https://www.nngroup.com/articles/ten-usability-heuristics/"}> Nielsen Norman
                                Group’s
                        ...
                        <GridEntry left>
                            ...
                            <Grid container item xs={12} spacing={1}>
                                ...
                                <Grid item xs={4}>
                                    <Paper style={section}>
                                        Make Net Worth its own category (Status bar?). Put question mark button next to
                                        net
                            ...
                            <Grid container item xs={12} spacing={1}>
                                <Grid item xs={4}>
                                    <Paper style={section}>
                                        Budget history does not give enough information to judge how well you budgeted
                                        that
                                        month
                                    </Paper>
                                </Grid>
                                ...
                                <Grid item xs={4}>
                                    <Paper style={section}>
                                        Make columns called "Your Budget", "What you spent", "Percentage saved" and
                                        include
                            ...
                            <Grid container item xs={12} spacing={1}>
                                ...
                                <Grid item xs={4}>
                                    <Paper style={section}>
                                        Add a summary at the top of the report that calculates their average rate of
                                        return
                                    </Paper>
                                </Grid>
                            </Grid>
                        ...
                        <GridEntry left>
                            ...
                            <Typography variant={"body1"}>
                                ...
                                (Right- After) Dashboard summarizes user’s progress at the top and has buttons to
                                clarify
                        ...
                        <GridEntry right>
                            ...
                            <Typography variant={"body1"}>
                                (Left- Before) The Linked Accounts page was unclear how to edit and remove certain
                                accounts.
                        ...
                        <GridEntry left>
                            ...
                            <Typography variant={"body1"}>
                                (Left- Before) It was hard for users to draw a conclusion on their overall performance
                                and
                                to see specific lengths of time. (Right- After) The summary box at the top indicates how
                                well the user’s portfolio is doing and the filter feature allows the user to see
                                specific
                                time intervals.
                            </Typography>
                        </GridEntry>
                        ...
                        <GridEntry>
                            <img style={myStyle} src={"../prototype/Grab9.png"} width={"33.3%"}
                                 alt={"Budget Home Screen"}/>
                        ...
                        <GridEntry>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                We are proud of the journey we’ve taken throughout this process and especially proud of
                                our
                                ...
                                essential to build our final design. The competitor analysis allowed us to get an idea
                                of
                                what features were common in financial applications and how to set our design apart from
                                the
                                rest. User research let us understand what our users actually need and allowed us to
                                prioritize those features. User evaluations allowed us to tackle usability issues that
                                were
                                not noticeable to us as designers who knew the system well. Heuristic evaluations
                                allowed us
                                to follow general principles in order for our design to be even more intuitive and user
                                friendly. We are able to see that user-centered design can be a long, but rewarding
                                process
                                towards solving a problem. We are excited to take the skills and knowledge we’ve
                                accumulated
                        ...
                        <GridEntry>
                            ...
                            <Typography align={"left"} variant={"body1"}>
                                Thank you to our professor, Dr. Matthew Bietz, and our teaching assistants, Agnes
                                Romhanyi
